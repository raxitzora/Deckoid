...
const Footer = () => {
  ...
  return (
    <>
      <footer className="bg-gradient-to-r from-[#6F4EA2] to-[#2D233A] text-white py-12 px-6 lg:px-20 relative">
      ...
      {showButton && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-6 right-6 bg-[#6F4EA2] text-white p-3 rounded-full shadow-lg hover:bg-[#593a91] transition-all z-50"
        >
          <FaArrowUp />
        </button>
      )}
