...
const ContactForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const { name, email, phone, referralSource, subject, message } = form;

    const whatsappMessage = `Hello Deckoid,%0A
Name: ${name}%0A
Email: ${email}%0A
Phone: ${phone}%0A
Heard About Us: ${referralSource}%0A
Subject: ${subject}%0A
Message: ${message}`;
        ...
        >
          ...
          <div className="space-y-6">
            <input
              ...
              className="w-full p-4 rounded-lg bg-white/10 text-white placeholder-white/70 outline-none focus:ring-2 focus:ring-purple-500"
